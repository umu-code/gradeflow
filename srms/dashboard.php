<?php
session_start();
error_reporting(E_ALL); // Enable error reporting for all errors
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-primary" href="manage-students.php">
                                            ...
                                            $query1->execute();
                                            $totalstudents = $query1->fetchColumn(); // Fetch total students
                                            ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-danger" href="manage-subjects.php">
                                            <?php
                                            $sql = "SELECT COUNT(id) as total FROM tblsubjects";
                                            $query = $dbh->prepare($sql);
                                            $query->execute();
                                            $totalsubjects = $query->fetchColumn(); // Fetch total subjects
                                            ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:1%;">
                                        <a class="dashboard-stat bg-warning" href="manage-classes.php">
                                            <?php
                                            $sql2 = "SELECT COUNT(id) as total FROM tblclasses";
                                            $query2 = $dbh->prepare($sql2);
                                            $query2->execute();
                                            $totalclasses = $query2->fetchColumn(); // Fetch total classes
                                            ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:1%">
                                        <a class="dashboard-stat bg-success" href="manage-results.php">
                                            <?php
                                            $sql3 = "SELECT COUNT(DISTINCT StudentId) as total FROM tblresult";
                                            $query3 = $dbh->prepare($sql3);
                                            $query3->execute();
                                            $totalresults = $query3->fetchColumn(); // Fetch total results
                                            ?>
