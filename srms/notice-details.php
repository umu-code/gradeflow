        ...
        <div class="container my-5">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <?php 
                    $noticeid = $_GET['nid'];
                    $sql = "SELECT * FROM tblnotice WHERE id = ?";
                    $stmt = $mysqli->prepare($sql);
                    $stmt->bind_param("i", $noticeid); // Bind the parameter
                    $stmt->execute();
                    ...
                    ?>  
                        ...
                        <h3><?php echo htmlentities($row['noticeTitle']); ?></h3>
                        <p><strong>Notice Posting Date:</strong> <?php echo htmlentities($row['postingDate']); ?></p>
                        <hr color="#000" />
                        <p><?php echo htmlentities($row['noticeDetails']); ?></p>
