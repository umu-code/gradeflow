                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        while ($row = mysqli_fetch_assoc($result)) { ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="edit-class.php?classid=<?php echo htmlentities($row['id']); ?>" class="btn btn-info btn-xs"> Edit </a>
                                                                    <a href="manage-classes.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-xs">Delete</a>
                                                                </td>
                                                            </tr>
                                                    <?php $cnt++;
                                                        }
